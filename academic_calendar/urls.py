...
urlpatterns = [
    ...
    path('update/year/<int:pk>/', views.YearUpdateView.as_view(),
         name="update_year"),
    path('update/term/<int:pk>/<int:year_pk>', views.TermUpdateView.as_view(),
         name="update_term"),
    ...
    path('delete/year/<int:pk>/', views.YearDeleteView.as_view(),
         name='delete_year'),
    path('delete/term/<int:pk>/<int:year_pk>', views.TermDeleteView.as_view(),
         name='delete_term'),
