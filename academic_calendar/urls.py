...
urlpatterns = [
    ...
    path('list/terms/', views.TermListView.as_view(), name='term_list'),
    path('create/year/', views.YearCreateView.as_view(),
         name='create_year'),
    path('create/term/', views.TermCreateView.as_view(),
         name='create_term'),
    path('update/year/<int:pk>/', views.YearUpdateView.as_view(),
         name="update_year"),
    path('update/term/<int:pk>/', views.TermUpdateView.as_view(),
         name="update_term"),
    ...
    path('delete/year/<int:pk>/', views.YearDeleteView.as_view(),
         name='delete_year'),
    path('delete/term/<int:pk>/', views.TermDeleteView.as_view(),
         name='delete_term'),
